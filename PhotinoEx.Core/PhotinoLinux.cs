...
public class PhotinoLinux : Photino
{
    public PhotinoLinux(PhotinoInitParams initParams)
    {
    ...
    public GtkWidget? Window { get; set; }

    private GtkWidget? _webView { get; set; }
    private GdkGeometry? _hints { get; set; }
